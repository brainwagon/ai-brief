"""The ten Sources, and the one function that gathers them.
...
from . import arxiv, devto, github, hackernews, huggingface, reddit, the_decoder, wired
...
FETCHERS = {
    ...
    the_decoder.KEY: the_decoder.fetch,
